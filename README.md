...
In Figure [23] the average return of the SL portfolio is -0.0003 for the EW and -0.0026 for the VW. Hence, compared to [Homework 1](https://github.com/MiaFrey/SustainableFinanceH1) Question 9 the short-long portfolio here is better (-0.0003 \> -0.02 for EW and -0.0026 \> -0.07 for VW) as the returns increased and are no longer negative but almost zero.
...
As it can be seen in Figure [24], the return of the decarbonized portfolio is
